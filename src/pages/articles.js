...
const Article = ({ img, title, date, link }) => {
  return (
    ...
    border border-solid border-dark border-r-4 border-b-4 dark:border-light dark:bg-dark dark:text-light sm:flex-col"
    >
...
const articles = () => {
  return (
    <>
      <Head>
        <title>Yovie Aditya | Articles Page</title>
